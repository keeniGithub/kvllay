...
export function ShowcaseMetrics() {
  ...
  return (
    <section className="w-full flex flex-col items-center pt-1 sm:pt-2 pb-10 sm:pb-16 px-4 sm:px-6 lg:px-10 max-w-[1240px] mx-auto">
      <div className="w-full max-w-[960px] bg-[#0B0E17] border border-[#1E3B5C] rounded-xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.55)] mb-6 sm:mb-9">
      ...
      <div className="w-full max-w-[960px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-4">
        {metrics.map((metric) => {
          ...
          return (
            <div
              key={metric.title}
              className="bg-[#0E131F] border border-[#1B2436] hover:border-[#1E3B5C] rounded-xl p-3.5 sm:p-4.5 flex flex-col justify-between gap-2.5 sm:gap-3 transition-colors shadow-sm"
            >
