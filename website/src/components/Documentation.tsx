...
export function Documentation() {
  ...
  return (
    <section id="docs" className="w-full py-16 px-6 lg:px-10 max-w-[1240px] mx-auto scroll-mt-20">
      <div className="w-full bg-[#0E131F] border border-[#1E3B5C] rounded-3xl p-8 sm:p-12 lg:p-14 relative overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.55)]">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          <div className="lg:col-span-7 flex flex-col gap-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#00D2FF]/10 border border-[#00D2FF]/30 w-fit">
              <BookOpen className="size-3.5 text-[#00D2FF]" />
              ...
              {docsGuides.map((guide, idx) => (
                <div key={idx} className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#00D2FF]/15 flex items-center justify-center shrink-0 mt-0.5">
                    <CheckCircle2 className="size-3.5 text-[#00D2FF]" />
                  </div>
                  <div>
                    <h4 className="text-[14px] font-semibold text-[#F0F6FC]">{guide.title}</h4>
                    <p className="text-[12.5px] text-[#8B9BB4] leading-relaxed">{guide.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 px-5.5 py-3 bg-[#00D2FF] hover:bg-[#00b8e6] text-[#08090E] rounded-xl text-[14px] font-bold transition-all shadow-[0_0_20px_rgba(0,210,255,0.2)] hover:shadow-[0_0_25px_rgba(0,210,255,0.35)]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 px-5 py-3 bg-[#0A0E17] hover:bg-[#161D2E] border border-[#1E3B5C] hover:border-[#00D2FF]/50 text-[#F0F6FC] rounded-xl text-[14px] font-medium transition-colors"
              >
                <FileText className="size-4 text-[#8B9BB4]" />
                <span>Russian Docs (ru.md)</span>
                <ExternalLink className="size-3.5 text-[#546682]" />
              </a>
            </div>
          </div>
              ...
              <div className="relative bg-[#070A10] border border-[#1E3B5C] rounded-2xl p-4 sm:p-5 flex flex-col items-center gap-3 overflow-hidden shadow-2xl">
                ...
                <div className="w-full rounded-xl overflow-hidden bg-[#0A0E17] flex items-center justify-center">
                  <picture className="w-full flex items-center justify-center">
                    <source srcSet="/allay_docs.webp" type="image/webp" />
                    <img
                      src="/allay_docs.gif"
