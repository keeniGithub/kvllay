...
| :--- | :---: | :---: | :--- |
| **Конвейерные запросы (P=64, 100 кл.): GET** | **5 494 505 RPS** | 2 531 645 RPS | **kvllay быстрее в 2.17x (+117% / ~5x к базовому Redis)** |
| **Конвейерные запросы (P=32, 50 кл.): GET** | **4 000 000 RPS** | 2 057 613 RPS | **kvllay быстрее на +94.4%** |
| **Конвейерные запросы (P=32, 50 кл.): SET** | **2 840 909 RPS** | 1 488 095 RPS | **kvllay быстрее на +90.9%** |
...
| **Задержка p50 (Конвейер P=64)** | **0.567 мс (567 мкс)** | 2.359 мс (2359 мкс) | **kvllay задержка в 4.2 раза ниже** |
